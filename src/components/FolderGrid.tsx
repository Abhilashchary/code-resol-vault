...
import { Folder, File, MoreVertical, Download, Trash2, Star, Eye, User, FolderOpen, Share2, Edit, Copy } from "lucide-react";
...
const FolderGrid = ({
  ...
  const handleRename = async (newName: string) => {
    ...
    if (renameItem.type === "file" && onRenameFile) {
      await onRenameFile(renameItem.id, newName);
    } else if (renameItem.type === "folder" && onRenameFolder) {
      await onRenameFolder(renameItem.id, newName);
    }
  };
